...
$logbestand = "true";
   ...
   if(!empty($_SERVER['HTTP_CLIENT_IP'])){
    ...
    if($ipadress === "::1"){
		...
		$query_iplogs = "INSERT into iplogs(ips,host,datum) values('$ipadress','$hostip','$datum')";
		mysql_query($query_iplogs) or die("error in $query_upload == ----> ".mysql_error());
